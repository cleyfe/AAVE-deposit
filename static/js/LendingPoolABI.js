...
export function myAbiERC() {
  return abiERC;
}

export function myLendingPoolAddressProviderContract() {
  return lendingPoolAddressProviderContract;
}

export function myLendingPoolABI() {
  return lendingPoolABI;
}
  
export function myIPool() {
  return IPool;
}
